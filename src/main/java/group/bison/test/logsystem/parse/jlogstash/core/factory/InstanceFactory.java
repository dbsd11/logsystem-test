...
import group.bison.test.logsystem.parse.jlogstash.core.annotation.plugin.AnnotationInterface;
import group.bison.test.logsystem.parse.jlogstash.core.property.SystemProperty;
import group.bison.test.logsystem.parse.jlogstash.core.classloader.JARClassLoaderFactory;
...
public abstract class InstanceFactory {
	...
	protected static String getClassName(String type,String pluginType){
		String className = group.bison.test.logsystem.parse.jlogstash.core.utils.Package.getRealClassName(type, pluginType);
        return className;
	}
